...
<div class="wrapper">
    ...
    <h3>user...</h3>
        ...
        <form class="form" action="assignments" method="POST">
        @csrf
            <h1 class="topic">ASSIGNMENTS</h1><br><br><br>
            <label for="description"><b>Description: </b></label>
            <input type="text" id="description" name="description" required><br><br><br><br>
            <label for="deadline"><b>Deadline: </b></label>
            <input type="date" id="deadline" name="deadline" required><br><br><br><br>
