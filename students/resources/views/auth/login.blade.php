...
<html lang="en" style="font-size: 100%;">
  ...
  <body class="is-preload">
    ...
    <!-- Header -->
      <header id="header">
        <div><a class="logo" href="index"><img src="images/logob.png" height="44px" width="60px" class="img-fluid"></a></div>
        <nav>
          <a href="#menu">Menu</a>
        </nav>
      </header>
          ...
          <li><a href="index">Home</a></li>
                  ...
                  <?php
                    if(isset($_SESSION['username'])){
                      ...
                      echo '<li><a href="registeration">Register</a></li>';
                    }
                  ?>
        </ul>
      </nav>
    ...
    <br>
    <form method="POST" id="login" action="verify">
